    ...
    <Card className={`w-full max-w-md mx-auto bg-gradient-to-r from-blue-50 to-indigo-50 shadow-lg rounded-lg overflow-hidden transition-all duration-300 ease-in-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      <div className="p-6">
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Base Name Required</h3>
            <p className="mt-1 text-sm text-gray-600">
              You need a Base Name to access this page. Claim yours now to continue.
            </p>
          </div>
          <Button 
            className="w-full bg-blue-600 hover:bg-blue-700 text-white transition-colors duration-200"
            onClick={() => window.location.href = 'https://www.base.org/names'}
          >
            Claim your Base Name
          </Button>
        </div>
      </div>
    </Card>
